...
print("HELLO WELCOME ! YOU ARE WELCOMED TO YOUR OWN DATA ANALYSIS TOOL ")
print("THERE ARE A FEW STEPS THAT YOU NEED TO FOLLOW TO PERFORM VARIOUS OPERATIONS ON YOUR DATA")
your_file = input("Enter the path to your data here:")
if not os.path.exists(
        your_file):  ########################### CHECK IF THE FILE EXISTS OR NOT #######################################
    print("SORRY NO SUCH FILE EXISTS CHECK THE FILE PATH AND TRY AGAIN:")
else:
    if your_file.endswith(
            ".csv"):  ############################ CHECK THE EXTENSION OF THE FILE ######################################
